 ...
 * the License.
 */
package com.lwc.generator.config.builder;
...
import com.lwc.generator.config.po.TableField;
import com.lwc.generator.config.po.TableFill;
import com.lwc.generator.config.po.TableInfo;
import com.lwc.generator.config.querys.H2Query;
...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.ENTITY_EXT, joinPackage(config.getParent(), config.getEntityExt()));
        ...
        packageInfo.put(ConstVal.FALLBACK, joinPackage(config.getParent(), config.getFallback()));
        packageInfo.put(ConstVal.PAYLOAD, joinPackage(config.getParent(), config.getPayload()));
        packageInfo.put(ConstVal.HANDLER, joinPackage(config.getParent(), config.getHandler()));
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getEntityExt(), outputDir, ConstVal.ENTITY_EXT_PATH, ConstVal.ENTITY_EXT);
            ...
            setPathInfo(pathInfo, template.getFallback(), outputDir, ConstVal.FALLBACK_PATH, ConstVal.FALLBACK);
            setPathInfo(pathInfo, template.getPayload(), outputDir, ConstVal.PAYLOAD_PATH, ConstVal.PAYLOAD);
            setPathInfo(pathInfo, template.getHander(), outputDir, ConstVal.HANDLER_PATH, ConstVal.HANDLER);
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (StringUtils.isNotEmpty(globalConfig.getFeignName())) {
                tableInfo.setFeignName(String.format(globalConfig.getFeignName(), entityName));
            } else {
                tableInfo.setFeignName(entityName + ConstVal.FEIGN);
            }
            if (StringUtils.isNotEmpty(globalConfig.getEntityExtName())) {
                tableInfo.setEntityExtName(String.format(globalConfig.getEntityExtName(), entityName));
            } else {
                tableInfo.setEntityExtName(entityName + ConstVal.ENTITY_EXT);
            }
            ...
            if (StringUtils.isNotEmpty(globalConfig.getFallbackName())) {
                tableInfo.setFallbackName(String.format(globalConfig.getFallbackName(), entityName));
            } else {
                tableInfo.setFallbackName(entityName + ConstVal.FALLBACK);
            }
            if (StringUtils.isNotEmpty(globalConfig.getPayloadName())) {
                tableInfo.setPayloadName(String.format(globalConfig.getPayloadName(), entityName));
            } else {
                tableInfo.setPayloadName(entityName + ConstVal.PAYLOAD);
            }
            if (StringUtils.isNotEmpty(globalConfig.getHandlerName())) {
                tableInfo.setHandlerName(String.format(globalConfig.getHandlerName(), entityName));
            } else {
                tableInfo.setHandlerName(entityName + ConstVal.HANDLER);
            }
