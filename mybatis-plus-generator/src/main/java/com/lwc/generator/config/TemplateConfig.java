...
public class TemplateConfig {
    ...
    private String entityExt = ConstVal.TEMPLATE_ENTITY_EXT;

    private String dao = ConstVal.TEMPLATE_DAO;

    private String daoImpl = ConstVal.TEMPLATE_DAO_IMPL;

    private String fallback = ConstVal.TEMPLATE_FALLBACK;

    private String payload = ConstVal.TEMPLATE_PAYLOAD;

    private String hander = ConstVal.TEMPLATE_HANDLER;
