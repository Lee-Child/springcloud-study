...
//    @Setter(AccessLevel.NONE)
    ...
    /**
     * 自定义继承的FeignApi类全称，带包名
     */
    private String superFeignClass = ConstVal.SUPER_FEIGN_CLASS;
    /**
    ...
    /**
     * EntityExt类是否继承Entity类（默认 true）<br>
     */
    private boolean viewModelExtendEntity = true;
